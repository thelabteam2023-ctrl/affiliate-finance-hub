-- Ajuste: Excluir SAQUEs do RPC de conciliação pendente
-- SAQUEs já têm card dedicado "Saques Aguardando Confirmação" com ação de confirmar
-- Confirmar saque = conciliar saque, então não deve aparecer em dois lugares
