...
BEGIN
    ...
    IF v_has_entries THEN
      ...
      LOOP
        ...
        ELSIF p_resultado = 'VOID' THEN
          ...
          -- Lucro acumulado já é 0 por padrão
        END IF;
  ...
  -- 4) RECALCULAR TOTAIS DA SUREBET (Source of Truth DB-side)
  ...
  -- Sincronizar saldos de segurança
  ...
  RETURN jsonb_build_object(
    ...
    'lucro_prejuizo', v_perna_lucro_acumulado,
