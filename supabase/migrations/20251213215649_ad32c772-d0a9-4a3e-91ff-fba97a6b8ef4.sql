-- Corrigir constraint de destino_tipo para permitir NULL (despesas externas ao sistema)
...
CHECK (
  destino_tipo IS NULL  -- Permitir NULL para despesas administrativas (externas ao sistema)
  OR destino_tipo = ANY (ARRAY[
