...
-- Recreate moderate_delete_topic function with correct column structure
...
BEGIN
  ...
  SELECT current_workspace_id INTO v_workspace_id
  FROM profiles
  WHERE id = auth.uid();
...
-- Recreate moderate_delete_comment function with correct column structure
