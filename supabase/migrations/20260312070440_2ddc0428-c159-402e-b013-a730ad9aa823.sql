...
BEGIN
  ...
  -- 1. Alertas (v_painel_operacional — view uses get_current_workspace() internally)
  ...
  IF p_include_partner THEN
    ...
    -- 5. Bonus pendentes (v_custos_aquisicao lacks workspace_id, filter via indicador_acordos)
