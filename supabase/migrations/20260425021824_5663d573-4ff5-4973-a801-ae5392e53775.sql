...
BEGIN
  ...
  THEN
    ...
    IF v_usage_count = 0 THEN
      ...
      BEGIN
        INSERT INTO financial_debug_log (op, bookmaker_id, old_project_id, new_project_id, resolved_project_id, event_type, payload)
        VALUES (
          TG_OP,
          NEW.id,
          OLD.projeto_id,
          ...
          jsonb_build_object(
            ...
            'bookmaker_id', NEW.id,
            'projeto_id', NEW.projeto_id,
            'trigger_version', 'usage_based_v2_debug_log_shape_fix'
          )
        );
  ...
  IF v_dv_valor > 0.009 THEN
    INSERT INTO cash_ledger (
      ...
      jsonb_build_object(
        ...
        'trigger_version', 'real_only_migracao_v5_debug_log_shape_fix'
      )
    );
  END IF;
