...
BEGIN
  ...
  -- Detecta DV baseline atual deste ciclo
  ...
  IF v_dv_baseline_id IS NOT NULL THEN
    ...
    -- Movimentação real no ledger após o vínculo
  ...
  -- Snapshots de pendentes/liquidadas (comportamento original)
