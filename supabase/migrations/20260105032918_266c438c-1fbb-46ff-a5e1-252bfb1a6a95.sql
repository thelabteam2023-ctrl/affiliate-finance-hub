-- Corrigir funções RPC para usar valores corretos do enum audit_action (MAIÚSCULAS)

-- 1. Recriar force_relogin_global com 'UPDATE' em maiúsculas
...
-- 2. Recriar force_relogin_workspace com 'UPDATE' em maiúsculas
...
-- 3. Recriar force_relogin_user com 'UPDATE' em maiúsculas
