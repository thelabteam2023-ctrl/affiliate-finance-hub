...
ALTER TABLE public.cash_ledger ADD CONSTRAINT cash_ledger_tipo_transacao_check CHECK (
  tipo_transacao = ANY (ARRAY[
    ...
    'DEPOSITO','SAQUE','SAQUE_VIRTUAL','DEPOSITO_VIRTUAL','DEPOSITO_BASELINE',
    'TRANSFERENCIA','APORTE_FINANCEIRO',
    'PERDA_OPERACIONAL','PERDA_REVERSAO',
    'CONCILIACAO','ESTORNO',
    'EVENTO_PROMOCIONAL','GANHO_CAMBIAL','PERDA_CAMBIAL',
    ...
    'RENOVACAO_PARCERIA','BONIFICACAO_ESTRATEGICA','ALOCACAO_FORNECEDOR',
    'SWAP_OUT','SWAP_IN'
  ])
);
