...
-- Atualizar v_saldo_parceiro_wallets para usar qtd_coin como fallback para saldo_usd
            ...
            sum(
                CASE
                    WHEN cl.destino_wallet_id = w.id AND cl.transit_status = 'CONFIRMED'::text THEN 
                      COALESCE(cl.valor_usd, CASE WHEN cl.coin IN ('USDT','USDC') THEN cl.qtd_coin ELSE 0::numeric END)
...
-- Atualizar v_wallet_crypto_balances com mesmo fallback
