...
BEGIN
  ...
  -- 1. Alertas (v_painel_operacional)
  ...
  -- 13. Propostas count
  SELECT COUNT(*)::int INTO v_section FROM pagamentos_propostos WHERE status = 'PENDENTE';
