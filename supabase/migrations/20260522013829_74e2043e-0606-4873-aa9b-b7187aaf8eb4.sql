-- Atualizar RPC de Edição para sincronizar campos de resumo
...
BEGIN
  ...
  FROM (
    SELECT 
      ...
      MIN(moeda) as main_moeda,
      MIN(bookmaker_id) as main_bookmaker_id
  ...
  -- 6. Recalcular Lucro/ROI Final (RPC Interna)
