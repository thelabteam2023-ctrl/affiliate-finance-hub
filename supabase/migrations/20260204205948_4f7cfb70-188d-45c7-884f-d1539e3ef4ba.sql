-- =================================================================
-- CORREÇÃO: reliquidar_aposta_v5 com nomes corretos das colunas
-- tipo_evento (não event_type), created_by (não user_id)
-- =================================================================
...
'v9.5 - Reliquida aposta usando financial_events (colunas corretas: tipo_evento, created_by)';