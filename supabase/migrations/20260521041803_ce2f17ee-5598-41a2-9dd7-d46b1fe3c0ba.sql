...
BEGIN
    ...
    IF NOT v_has_pernas THEN
        ...
        RAISE NOTICE 'DEBUG: odd_inicial=%', v_effective_odd;
        ...
        IF COALESCE(v_aposta.boost_percentual, 0) > 0 THEN
            ...
            RAISE NOTICE 'DEBUG: odd_com_boost=%', v_effective_odd;
        END IF;
        ...
        IF p_resultado IN ('GREEN', 'MEIO_GREEN', 'VOID', 'MEIO_RED', 'RED', 'CANCELADA') THEN
            ...
            RAISE NOTICE 'DEBUG: payout_total=%', v_payout_total;
