...
BEGIN
  ...
  -- CORREÇÃO: Verificar se realmente existem freebets para esta bookmaker
  -- antes de usar tipo_uso FREEBET. Isso evita gerar saldo freebet espúrio
  -- quando fonte_saldo foi marcado como FREEBET sem freebet real.
