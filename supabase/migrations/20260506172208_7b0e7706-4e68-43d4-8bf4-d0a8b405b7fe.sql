-- Fix fn_recalc_aposta_consolidado: caminho fallback para apostas SIMPLES sem pernas/entradas
...
BEGIN
  ...
  ELSIF v_has_pernas THEN
    ...
    END LOOP;
  ELSE
    -- CAMINHO SIMPLES (sem pernas, sem entradas) — usa campos da própria aposta
    ...
    ELSE
      -- PENDENTE: não projetar lucro (consolidado fica 0)
  ...
  IF v_is_multi THEN
    ...
    -- Apenas para ARBITRAGEM o lucro_prejuizo segue o consolidado (legado)
