...
BEGIN
  ...
  -- Stakes de apostas simples (bookmaker_id preenchido no registro pai)
  ...
  -- Stakes de pernas individuais (Surebets/Múltiplas onde bookmaker_id é NULL no pai)
  ...
  -- Consolidar ambas as fontes de stakes pendentes
