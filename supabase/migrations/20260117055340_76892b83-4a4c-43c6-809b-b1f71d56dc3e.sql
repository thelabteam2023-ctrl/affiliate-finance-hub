...
-- Corrigir função: usar colunas corretas de giros_gratis
...
BEGIN
  ...
  -- Giros grátis (usando coluna correta: valor_retorno, status = CONVERTIDO)
...
Não depende de filtro por estratégia - todas as pernas são incluídas automaticamente.';
