...
import { Handshake, AlertTriangle, CheckCircle, Clock, XCircle, LayoutGrid, List, LogOut, Bell } from "lucide-react";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Gestão de Parcerias</h1>
          <p className="text-muted-foreground">
            Controle de parcerias com prazos e alertas
          </p>
        </div>
