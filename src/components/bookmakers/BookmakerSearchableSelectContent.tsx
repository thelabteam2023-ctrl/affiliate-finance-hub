  ...
  return (
    <SelectPrimitive.Portal>
      ...
      >
        ...
        {showSearch && (
          <div className="px-2 py-1.5 bg-popover border-b border-border shadow-md">
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((bk) => {
              ...
              const adjustedBk = freebetOverrides?.has(bk.id)
                ...
                : bk;
              return (
                <SelectItem key={bk.id} value={bk.id} className={cn("py-2.5 pl-8 pr-2", itemClassName)}>
