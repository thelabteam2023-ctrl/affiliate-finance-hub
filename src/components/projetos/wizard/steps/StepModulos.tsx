  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-semibold mb-1">Módulos do Projeto</h2>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <h2 className="text-xl font-semibold">Módulos do Projeto</h2>
            <Badge variant="secondary" className="text-xs">Opcional</Badge>
          </div>
          <p className="text-sm text-muted-foreground">
            Selecione as estratégias que você usará neste projeto
          </p>
        </div>
      ...
      <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
        ...
        <p className="text-xs text-muted-foreground">
          Você poderá ativar ou desativar módulos a qualquer momento em{" "}
          <strong>Gestão → Módulos</strong>.
        </p>
      </div>
