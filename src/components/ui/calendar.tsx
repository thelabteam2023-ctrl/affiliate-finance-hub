...
function Calendar({ className, classNames, showOutsideDays = true, captionLayout, ...props }: CalendarProps) {
  // Hide caption_label when using dropdown layouts to avoid duplication
    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-background p-0 opacity-70 hover:opacity-100 hover:bg-accent/40",
        ),
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent/40 hover:text-accent-foreground"),
