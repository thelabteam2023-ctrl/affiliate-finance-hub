  ...
  return (
    <>
      ...
      <ParceirosListModal
        ...
        title={`Parceiros indicados por ${indicador.nome}`}
        subtitle={`${indicador.total_parceiros_indicados} parceiro${indicador.total_parceiros_indicados !== 1 ? "s" : ""} indicado${indicador.total_parceiros_indicados !== 1 ? "s" : ""}`}
        parceiros={parceirosNomes.map(d => ({ nome: d.parceiroNome }))}
      />
    </>
  );
}
