    ...
    <TooltipProvider>
      <div className="h-full flex flex-col">
        ...
        >
          ...
          {/* Aba Resumo */}
          <TabsContent value="resumo" className="flex-1 min-h-0 mt-0">
            <ScrollArea className="h-full">
              <div className="p-4 h-full min-h-0 flex flex-col gap-3">
                ...
                {/* Tabela por Casa de Apostas - Header fixo + lista com scroll interno */}
                <div className="border border-border rounded-lg flex flex-col flex-1 min-h-0">
