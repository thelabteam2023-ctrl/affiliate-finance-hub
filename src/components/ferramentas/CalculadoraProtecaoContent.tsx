          ...
          <div className="space-y-4 p-4 rounded-lg bg-muted/30 border border-border">
            ...
            {tipoAposta === 'personalizado' && (
              <div className="flex items-center gap-3">
                <Label className="text-xs text-muted-foreground">Número de pernas:</Label>
                <div className="flex items-center gap-2">
                  ...
                  <span className="w-8 text-center font-medium">{numPernas}</span>
                  <Button 
                    variant="outline" 
                    size="icon" 
                    className="h-8 w-8"
            ...
            >
              ...
              <div className="flex items-center space-x-3 p-2 rounded hover:bg-muted/50 transition-colors">
                ...
                <Label htmlFor="neutralizar_greens" className="text-sm cursor-pointer flex-1">
                  Quero neutralizar greens inesperados
                </Label>
              </div>
            </RadioGroup>
          </div>
