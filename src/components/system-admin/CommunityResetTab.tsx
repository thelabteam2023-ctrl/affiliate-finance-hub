...
import { AlertTriangle, MessageSquare, Star, MessagesSquare, Flag, Trash2, RefreshCw, CheckCircle2 } from 'lucide-react';
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle>Reset do Módulo Comunidade</CardTitle>
            <CardDescription>
        ...
        <div className="flex items-start gap-3 p-4 rounded-lg bg-destructive/10 border border-destructive/20">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground mt-1">
              Esta operação irá remover permanentemente todos os dados do módulo Comunidade.
              Execute primeiro uma simulação (dry-run) para ver quantos registros serão afetados.
            </p>
          </div>
        </div>
