   ...
   */
   ...
   const resetContextoDependente = (resetMoedaCoin: boolean = true, resetValores: boolean = true, preserveTransactionContext: boolean = false) => {
     ...
     setShowNoWalletAlert(false);
       setDataTransacao("");
       setTags([]);
         // NÃO resetar fluxoAporte aqui: a direção (Investidor→Caixa vs
         // Caixa→Investidor) é escolha explícita do usuário e não depende de
         // moeda/coin. Reset restrito a resetForm() e troca de tipoTransacao.
    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 pt-2 pb-4">
          ...
          {/* ====== VALOR (movido para após Origem/Destino — sequência natural de UX) ====== */}
          {tipoTransacao && tipoMoeda === "FIAT" && (
            <div className="pt-4 border-t border-border space-y-3">
              <h3 className="text-[10px] font-semibold text-center uppercase tracking-widest text-muted-foreground">
                Valor da Transação
              </h3>
                ...
                <div className="grid grid-cols-2 gap-3 max-w-2xl mx-auto">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      readOnly
                      disabled
                      className="h-14 text-3xl text-center font-medium tabular-nums tracking-tight bg-muted/50"
                    />
