          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center">
              <Select value={filtroTipo} onValueChange={setFiltroTipo}>
                <SelectTrigger className={`h-8 text-xs whitespace-nowrap min-w-[140px] w-auto [&>span]:justify-start [&>span]:gap-1.5 [&>span]:flex-nowrap ${filtroTipo !== "TODOS" ? "bg-secondary border-secondary" : "border-border/50"}`}>
